...
import com.genth.kkdc.model.KK_UL_CallbackModel;
 ...
 */
@Controller
@RequestMapping("KK_UL_Callback")
public class KK_UL_CallbackController {
	...
	public @ResponseBody KK_UL_CallbackModel getList(
		...
		List<KK_UL_Callback> kkCallBackList = new ArrayList<KK_UL_Callback>();
		KK_UL_CallbackModel model = new KK_UL_CallbackModel();
...
//		System.out.println("1==>"+searchStatus);
	...
	public @ResponseBody String userConfirm(@RequestBody Object obj) {
		...
		try {
			...
			ObjectMapper mapper = new ObjectMapper();
			KK_UL_Callback cb = mapper.convertValue(obj, new TypeReference<KK_UL_Callback>() { });
