...
public class BillpaymentNotice implements Serializable {
    ...
    public BillpaymentNotice() {
    }

    public BillpaymentNotice(Object obj[], int startIndex) {
    ...
    public BillpaymentNotice(BillpaymentNotice doc) {
