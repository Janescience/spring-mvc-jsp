...
public class KK_Document implements Serializable {
    ...
    public KK_Document(Object obj[], int startIndex) {
    	...
    	this.setIsCompleteSendMail(obj[startIndex++].toString());
    	this.setFileServer(obj[startIndex++].toString());
    	this.setStaffEmail(obj[startIndex++].toString());
    	this.setCntPdf(obj[startIndex++].toString());
    	this.setKkRefNo(obj[startIndex++].toString());
    	
    }
    
    public KK_Document(KK_Document doc) {
    	...
    	this.docLogIdArr=doc.getDocLogIdArr();
	...
	public String getDocLogIdArr() {
		return docLogIdArr;
	}

	public void setDocLogIdArr(String docLogIdArr) {
		this.docLogIdArr = docLogIdArr;
	}
