...
public class KK_Document_ForKKGENBIZ implements Serializable {
    ...
    public KK_Document_ForKKGENBIZ() {
    }

    public KK_Document_ForKKGENBIZ(Object obj[], int startIndex) {
    ...
    public KK_Document_ForKKGENBIZ(KK_Document_ForKKGENBIZ doc) {
