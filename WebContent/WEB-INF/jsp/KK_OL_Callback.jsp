...
<script type="text/javascript">
	...
	$().ready(function() {
		...
		var mygrid = grid.jqGrid({
		    ...
		    datatype : "json",
			url : "KK_OL_Callback/list.html?custNameSearch="+custNameSearch+"&searchStatus="+searchStatus,
			mtype : "GET",
		    colNames:["<spring:message code='kkDocument.lbl1'/>", // Primary Key hidden
		              ...
		              "รหัสพนักงาน",
		              "ชื่อพนักงาน",
		              "เลขที่ใบอนุญาตนายหน้าประกันชีวิต", // Hidden
		              "เลขที่ใบอนุญาตผู้แนะนําการลงทุน ", // Hidden
		              "สาขา",
		              "แบบประกัน",
		              "เบี้ยประกัน",
		              "เบี้ยประกัน Rider",
		              ...
		              "AppNo",   
		              "KKRefNo", // Hidden   
		              "first_review_timestamp", // Hidden   
		              "pf_planCode", // Hidden   
		              "pf_planName", // Hidden   
		              "pf_coverageTerm", // Hidden   
		              "pf_premiumTerm", // Hidden   
		              "pf_refundText", // Hidden
		              "paymentMode", //Hidden
		              "premiumHB",//Hidden
		              "premiumCI",//Hidden
		              "premiumWP", //Hidden
		    ...
		    colModel :[ 
		      ...
		      {name:'planName',index:'planName',	width:25,	sortable: true,	editable : false },
		      {name:'premium', index:'premium',	width:25,	sortable: true,	sorttype:'int' ,editable : false  },
		      {name:'premiumRider', index:'premiumRider',	width:25,	sortable: true,	sorttype:'int' ,editable : false  },
		      {name:'totalPremium', index:'totalPremium',	width:25,	sortable: true,	sorttype:'int' ,editable : false  },
		      {name:'sumInsured', index:'sumInsured',	width:25,	sortable: true,	sorttype:'int' ,editable : false , hidden : true },
		      ...
		      {name:'pf_planCode',index:'pf_planCode',width:15,	sortable: true, editable : false, hidden : true  }	,
		      {name:'pf_planName',index:'pf_planName',width:15,	sortable: true, editable : false, hidden : true  }	,
		      {name:'pf_coverageTerm',index:'pf_coverageTerm',width:15,	sortable: true, editable : false, hidden : true  }	,
		      {name:'pf_premiumTerm',index:'pf_premiumTerm',width:15,	sortable: true, editable : false, hidden : true  }	,
		      {name:'pf_refundText',index:'pf_refundText',width:15,	sortable: true, editable : false, hidden : true  }	,
		      {name:'paymentMode',index:'paymentMode',width:15,	sortable: true, editable : false, hidden : true  }	,
		      {name:'premiumHB',index:'premiumHB',width:15,	sortable: true, editable : false, hidden : true  }	,
		      {name:'premiumCI',index:'premiumCI',width:15,	sortable: true, editable : false, hidden : true  }	,
		      {name:'premiumWP',index:'premiumWP',width:15,	sortable: true, editable : false, hidden : true  }	,
		     // {name:'premiumADD',index:'premiumADD',width:15,	sortable: true, editable : false, hidden : true  }	,
		      {name:'premiumADB',index:'premiumADB',width:15,	sortable: true, editable : false, hidden : true  }	,
		      {name:'saCI',index:'saCI',width:15,	sortable: true, editable : false, hidden : true  }	,
		      {name:'saHB',index:'saHB',width:15,	sortable: true, editable : false, hidden : true  }	,
		      {name:'saWP',index:'saWP',width:15,	sortable: true, editable : false, hidden : true  }	,
		    //  {name:'saADD',index:'saADD',width:15,	sortable: true, editable : false, hidden : true  }	,
		      {name:'saADB',index:'saADB',width:15,	sortable: true, editable : false, hidden : true  }	,
		      {name:'checkRider',index:'checkRider',width:15,	sortable: true, editable : false, hidden : true  }	,
		...
		*/
		...
		grid.jqGrid('navButtonAdd',"#pager",{
			...
			onClickButton:function(){
				...
				if (row != null) {
					...
					var _premiumRider 	= grid.jqGrid ('getCell', row, 'premiumRider');	
					var _totalPremium 	= grid.jqGrid ('getCell', row, 'totalPremium');
					...
					var _pf_planName 				= grid.jqGrid ('getCell', row, 'pf_planName');	
					var _pf_coverageTerm 			= grid.jqGrid ('getCell', row, 'pf_coverageTerm');	
					var _pf_premiumTerm 			= grid.jqGrid ('getCell', row, 'pf_premiumTerm');	
					var _pf_refundText 				= grid.jqGrid ('getCell', row, 'pf_refundText');	
					var _paymentMode	= grid.jqGrid ('getCell', row, 'paymentMode');	
					...
					var _premiumHB 		= grid.jqGrid ('getCell', row, 'premiumHB');
					var _premiumCI 		= grid.jqGrid ('getCell', row, 'premiumCI');
					var _premiumWP 		= grid.jqGrid ('getCell', row, 'premiumWP');
					//var _premiumADD 		= grid.jqGrid ('getCell', row, 'premiumADD');
					var _premiumADB 		= grid.jqGrid ('getCell', row, 'premiumADB');
					var _saHB			= grid.jqGrid ('getCell', row, 'saHB');
					var _saCI			= grid.jqGrid ('getCell', row, 'saCI');
					var _saWP			= grid.jqGrid ('getCell', row, 'saWP');
				//	var _saADD			= grid.jqGrid ('getCell', row, 'saADD');
					var _saADB			= grid.jqGrid ('getCell', row, 'saADB');
					var _checkRider 	= grid.jqGrid ('getCell', row, 'checkRider');
					...
					$("#premiumRider").html(_premiumRider.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,") + " บาท");
					$("#totalPremium").html(_totalPremium.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,") + " บาท");
					$("#sumInsured").html(_sumInsured.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,") + " บาท");
					$("#myNote").val(_kkNote);
					$("#myNoteFromBranch").val(_noteFromBranch);
					
					$("#divSA").html(_sumInsured.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"));
					$("#divPrem").html(_premium.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"));
					
					$("#firstReview").html(_firstReviewTimestamp);
					$("#divPlanName").html(_pf_planName);
					$("#divCoverageTerm").html(_pf_coverageTerm);
					$("#divPremiumTerm").html(_pf_premiumTerm);
					$("#divRefundText").html(_pf_refundText);
					$("#divPaymentMode").html(_paymentMode);
					$("#divPlan").html("&nbsp;&nbsp;&nbsp;แบบประกัน "+_planName);
					
					$("#divPremiumHB").html(_premiumHB);
					$("#divPremiumCI").html(_premiumCI);
					$("#divPremiumWP").html(_premiumWP);
					//$("#divPremiumADD").html(_premiumADD);
					$("#divPremiumADB").html(_premiumADB);
					$("#divSaHB").html(_saHB);
					$("#divSaCI").html(_saCI);
					$("#divSaWP").html(_saWP);
					//$("#divSaADD").html(_saADD);
					$("#divSaADB").html(_sumInsured.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"));
					$("#divTotalPrem").html(_totalPremium);
					...
					/*var getFundListResult = $.ajax({
				    	url: "KK_OL_Callback/getFundList.html",
				        type: "POST",
					...
					*/
					...
					if(_checkRider == '0'){
						$('#showRider').css("display", "none");
						$('#displayHB').css("display", "none");
						$('#displayCI').css("display", "none");
						$('#displayWP').css("display", "none");
						$('#displayADB').css("display", "none");
						$('#showTotal').css("display", "none");
						
					}else{		
					
						$('#showRider').css("display", "block");
						$('#showTotal').css("display", "block");
						if(_premiumHB == '0.00' && _saHB == '0.00' ){
							$('#displayHB').css("display", "none");
						} //9943
						
						if(_premiumCI == '0.00' && _saCI == '0.00' ){
							$('#displayCI').css("display", "none");
						}//9416
						if(_premiumWP == '0.00' && _saWP == '0.00' ){
							$('#displayWP').css("display", "none");
						}//9940
						
						/*
						if(_premiumADD == '0.00' && _saADD == '0.00' ){
							$('#displayADD').css("display", "none");
						}*/ // 991A
						if(_premiumADB == '0.00' && _saADB == '0.00' ){
							$('#displayADB').css("display", "none");
						}
					}
		...
		$("#btnSearchCallback").button().click(function() {
			...
			window.location.replace("KK_OL_Callback.html?custNameSearch="+custNameSearch+"&searchStatus="+searchStatus);
		});	
		...
		$("#btnPrintDoc").button().click(function() {
			...
			_url = '<%=request.getContextPath()%>/exportCallbackReport/export_OL_CallbackReport.html';
		...
		$("#btnCallbackSuccess").button().click(function() {
			...
			//alert(paramObj);
			var confirmCb = $.ajax({
		    	url: "KK_OL_Callback/userConfirm.html",
		        type: "POST",
		        data: JSON.stringify(paramObj),
		        async:false, 
		       // dataType: "json",
...
<body>
	...
	<div id="searchBillDiv">
	 ...
	 --> 
		...
		<div class="right">
		Approved Date From:
		<input class="docDateTextBox" type="text" id="exportStartDate" name="exportStartDate" value="" pattern="^([1-9]|0[1-9]|1[0-9]|2[0-9]|3[0-1])\/([1-9]|0[1-9]|1[0-2])\/\d{4}$" />
		To:
		<input class="docDateTextBox" type="text" id="exportEndDate" name="exportEndDate" value="" pattern="^([1-9]|0[1-9]|1[0-9]|2[0-9]|3[0-1])\/([1-9]|0[1-9]|1[0-2])\/\d{4}$" />
 ...
 <div id="inputPolicyDiv" style="display:none; margin-left: 50px; width: 750px; height: auto; ">
                        ...
                        <div>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <div id="divPlanName">เคเคเจน เวลท์ 12/5 (มีเงินปันผล)</div>
                                    </td>
                                </tr>
                                <tr>
                                	<td>
                                        <B>ระยะเวลาคุ้มครอง (ปี): </B>
                                    </td>
                                    <td colspan="2">
                                        <div id="divCoverageTerm">12</div>
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>
                                        <B>ระยะเวลาชำระเบี้ย (ปี) : </B>
                                    </td>
                                    <td colspan="2">
                                        <div id="divPremiumTerm">5</div>
                                    </td>
                                </tr>
                                <tr>
                                	<td valign="top">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <div id="divRefundText"></div>
                                    </td>
                                    <td>&nbsp;</td>
                                    <td valign="top">
                                        <B>งวดการชำระเบี้ยประกัน:</B>
                                    </td>
                                    <td colspan="2" valign="top">
                                ...
                                <tr style="border-bottom: 1px solid black;">
                                	<td valign="top" colspan="3">
                                	 ...
                                	 <td valign="top" colspan="2" style="text-align: center;">จำนวนเงินเอาประกันภัย / Sum assured</td>
                                    <td colspan="2" valign="top" style="text-align: center;">
                                     		   เบี้ยประกันภัย / Premium
                                    </td>
                                </tr>
                                <tr> 
                                	<td valign="top" colspan="3" id="divPlan">
                                		
                                	</td>
                                	 <td id="divSA" valign="top" colspan="2" style="text-align: center;"> </td>
                                	 <td id="divPrem" colspan="2" valign="top" style="text-align: center;">
                                     		
                                    </td>
                                </tr>
                              
                                 <tr id="showRider">
                                	<td valign="top" colspan="3" style="font-weight: bolder;">
                                		<b>สัญญาเพิ่มเติม</b>
                                	</td>
                                	 <td valign="top" colspan="2" style="text-align: center;"></td>
                                    <td colspan="2" valign="top" style="text-align: center;">
                                     		
                                    </td>
                                </tr>
                                 <tr id="displayHB"> 
                                	<td valign="top" colspan="3" style="width: 350px;">
                                		&nbsp;&nbsp;&nbsp;สัญญาเพิ่มเติมค่าชดเชยรายวันกรณีเข้ารักษาในโรงพยาบาล (HB)
                                	</td>
                                	 <td id="divSaHB" valign="top" colspan="2" style="text-align: center;"> </td>
                                	 <td id="divPremiumHB" colspan="2" valign="top" style="text-align: center;">
                                     		
                                    </td>
                                </tr>
                                 <tr id="displayCI"> 
                                	<td valign="top" colspan="3">
                                		&nbsp;&nbsp;&nbsp;สัญญาเพิ่มเติมประกันภัยโรคร้ายแรง เอ็กซ์ตร้า (CI Extra)
                                	</td>
                                	 <td id="divSaCI" valign="top" colspan="2" style="text-align: center;"> </td>
                                	 <td id="divPremiumCI" colspan="2" valign="top" style="text-align: center;">
                                ...
                                <tr id="displayWP"> 
                                	<td valign="top" colspan="3">
                                	 ...
                                	 <td  id="divSaWP" valign="top" colspan="2" style="text-align: center;"> </td>
                                	 <td id="divPremiumWP" colspan="2" valign="top" style="text-align: center;">
                                     		
                                    </td>
                                </tr>
                                <tr id="displayADB"> 
                                	<td valign="top" colspan="3">
                                		&nbsp;&nbsp;&nbsp;สัญญาเพิ่มเติม เอดีบี พลัส
                                	</td>
                                	 <td id="divSaADB" valign="top" colspan="2" style="text-align: center;"> </td>
                                	 <td id="divPremiumADB" colspan="2" valign="top" style="text-align: center;">
                                ...
                                <tr  id="displayADD"> 
                                	<td valign="top" colspan="4">
                                		&nbsp;&nbsp;&nbsp;สัญญาเพิ่มเติมการประกันภัยอุบัติเหตุคุ้มครองการเสียชีวิต และสูญเสียอวัยวะ ไลท์
                                	</td>
                                	 <td id="divSaADD" valign="top" colspan="2" style="text-align: center;"> </td>
                                	 <td id="divPremiumADD" colspan="2" valign="top" style="text-align: center;">
                                ...
                                <tr ="showTotal"> 
                                	<td valign="top" colspan="3">
                                		<b>รวมเบี้ยประกันภัยทั้งสิ้น</b>
                                	</td>
                                	 <td valign="top" colspan="2" style="text-align: center;"> </td>
                                	 <td id="divTotalPrem" colspan="2" valign="top" style="text-align: center;">
