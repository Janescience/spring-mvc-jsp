...
<title><spring:message code='QAV.lbl.title.caption'/></title>
...
<script type="text/javascript">
	$().ready(function() {
		...
		$('input:reset').click(function() {
			allFields.removeClass("ui-state-error");
			username.focus();
			document.location.replace("/QAV/auth/loginPopup.html");
		});
...
<body>
	...
	<div id="loginDialog" align="center" class="ui-widget">
		<form name="f" id="loginForm" action="<c:url value='QAV/j_spring_security_check'/>" method="post">
